...
class BooksServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBookById = channel.unary_unary(
                '/books.BooksService/GetBookById',
                request_serializer=books__pb2.GetBookRequest.SerializeToString,
                response_deserializer=books__pb2.Book.FromString,
                _registered_method=True)
        self.ListAllBooks = channel.unary_unary(
                '/books.BooksService/ListAllBooks',
                request_serializer=books__pb2.ListAllBooksRequest.SerializeToString,
                response_deserializer=books__pb2.GetAllBooksResponse.FromString,
                _registered_method=True)
...
def add_BooksServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListAllBooks': grpc.unary_unary_rpc_method_handler(
                    servicer.ListAllBooks,
                    request_deserializer=books__pb2.ListAllBooksRequest.FromString,
                    response_serializer=books__pb2.GetAllBooksResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'books.BooksService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('books.BooksService', rpc_method_handlers)
...
class BooksService(object):
    ...
    def ListAllBooks(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/books.BooksService/ListAllBooks',
            books__pb2.ListAllBooksRequest.SerializeToString,
            books__pb2.GetAllBooksResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
